 ...
 *
 * This file has been copied from https://github.com/lastguest/murmurhash-php/blob/master/src/lastguest/Murmur.php
 * because it was not compatible with PHP 8.
 *
 * @author Stefano Azzolini (lastguest@gmail.com)
 *
 * @see https://github.com/lastguest/murmurhash-php/blob/master/src/lastguest/Murmur.php
 */
class Murmur
{
	/**
